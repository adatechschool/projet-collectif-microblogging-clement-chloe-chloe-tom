    ...
    <div class="max-w-3xl mx-auto p-6">
        ...
        <div class="space-y-6">
            @forelse ($posts as $post)
                ...
                <a href="/posts/{{$post->id}}" class="block p-6 bg-white border border-gray-200 rounded-lg shadow transition-transform transform hover:scale-110 hover:shadow-lg hover:bg-gray">
